...
עדכון אחרון: 2026-06-15 — **התאמת hero banner לפי Figma**: איור גדול יותר (520px), קופסה קומפקטית, אפקט bleed (האיור חורג מעל/מתחת לקופסה). + **התאמת מיקום סיידבר ניווט לפי Figma**: ניווט עבר לימין (RTL-start), עוזר אישי עבר לשמאל (RTL-end), topbar מותאם, badge כתום עגול, "היסעים" disabled, ולוגו + תגית. + כפתור "רישום" בדשבורד פר-ילד + חזרה לדשבורד בסוף התהליך + עדיפויות ב׳ ו-ג׳ במסך בחירת מוסד עם תפריט נפתח + טקסט באנר אמיתי + תהליך רישום ילד נוסף דינמי + כתובת הורים מתפצלת + פיקסל-perfect לדשבורד עם אסטס מ-Figma. דשבורד פורטל הבית באוויר, תהליך הרישום מקוצר ל-7 שלבים, רספונסיבי מובייל מלא, נתוני דמו להצגה ללקוח.
...
*מסמך זה עודכן ב-2026-06-15 אחרי 20 PRs שמוזגו ל-main. כל הפיצ'רים שבוקשו ע"י הלקוח להצגה — הושלמו, והדשבורד תואם 1:1 למקור ב-Figma באמצעות הזרימה המקצועית design-to-code. תהליך הרישום תומך בילד נוסף דינמי, בכתובת הורים מתפצלת, וב-3 עדיפויות לבחירת מוסד עם תפריט נפתח. הדשבורד הוא נקודת הכניסה והיציאה היחידה לתהליך הרישום: כפתור "רישום" פר-ילד פותח את התהליך עם פרטי הילד הנכון, ובסוף התהליך המשתמש חוזר לדשבורד לבחור ילד אחר. **PR #21 (2026-06-15)** תיקן את מיקום סיידבר הניווט: עבר מצד שמאל לצד ימין (RTL-start) כדי להתאים 1:1 לצילום `111.jpeg` מ-Figma, פאנל העוזר האישי עבר לשמאל, ה-topbar הותאם (משפחה משמאל, חיפוש מימין), badge "3" הפך לעיגול כתום, "היסעים" קיבל סטייט disabled, והוספה תגית "הבית הדיגיטלי שלך" מתחת ללוגו. **PR #23 (2026-06-15)** השלים את ההתאמה: hero banner עם איור גדול ומרשים (520px במקום 360px), קופסה קומפקטית יותר (min-height 200px במקום 250px), ואפקט bleed - האיור חורג מעל/מתחת לקופסה הטורקיז (overflow visible + margin שלילי). הלקוח אישר: "עכשיו זה מושלם".*
