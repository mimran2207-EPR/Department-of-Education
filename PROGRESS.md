...
*מסמך זה עודכן ב-2026-06-15 אחרי 18 PRs שמוזגו ל-main. כל הפיצ'רים שבוקשו ע"י הלקוח להצגה — הושלמו, והדשבורד תואם 1:1 למקור ב-Figma באמצעות הזרימה המקצועית design-to-code. תהליך הרישום תומך בילד נוסף דינמי, בכתובת הורים מתפצלת, וב-3 עדיפויות לבחירת מוסד עם תפריט נפתח. הדשבורד הוא נקודת הכניסה והיציאה היחידה לתהליך הרישום: כפתור "רישום" פר-ילד פותח את התהליך עם פרטי הילד הנכון, ובסוף התהליך המשתמש חוזר לדשבורד לבחור ילד אחר. **PR #21 (2026-06-15)** תיקן את מיקום סיידבר הניווט: עבר מצד שמאל לצד ימין (RTL-start) כדי להתאים 1:1 לצילום `111.jpeg` מ-Figma, פאנל העוזר האישי עבר לשמאל, ה-topbar הותאם (משפחה משמאל, חיפוש מימין), badge "3" הפך לעיגול כתום, "היסעים" קיבל סטייט disabled, והוספה תגית "הבית הדיגיטלי שלך" מתחת ללוגו.*
