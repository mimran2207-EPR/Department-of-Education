...
*מסמך זה עודכן ב-2026-06-14 אחרי 15 PRs שמוזגו ל-main. כל הפיצ'רים שבוקשו ע"י הלקוח להצגה — הושלמו, והדשבורד תואם 1:1 למקור ב-Figma באמצעות הזרימה המקצועית design-to-code. תהליך הרישום תומך בילד נוסף דינמי, בכתובת הורים מתפצלת, וב-3 עדיפויות לבחירת מוסד עם תפריט נפתח. הדשבורד הוא נקודת הכניסה והיציאה היחידה לתהליך הרישום: כפתור "רישום" פר-ילד פותח את התהליך עם פרטי הילד הנכון, ובסוף התהליך המשתמש חוזר לדשבורד לבחור ילד אחר. טקסט הבאנר עודכן ממלל לורם איפסום למלל ברוכים הבאים אמיתי.*
