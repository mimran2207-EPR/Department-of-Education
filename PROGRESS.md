...
- [x] **6 קוביות פעולה** (עודכן 2026-06-15, פריסת grid 3×2 → 2×3 → 1×6 רספונסיבי) — **כל קוביה פותחת מודאל לבחירת ילד**:
  ...
  - ⚽ רישום לחוגים (טורקיז עדין #0a8794, רקע #d6f3f5 — צבע המותג) — **קוביה חדשה** (PR #26, צבע עודכן ב-PR #28) — בחירת ילד → "בקרוב"
...
| 28 | החלפת צבע "רישום לחוגים" מאינדיגו לטורקיז עדין (תואם המותג) | TBD |
